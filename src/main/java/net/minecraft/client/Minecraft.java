...
public class Minecraft implements IThreadListener, ISnooperInfo
{
    ...
    private static final int maxFrames = (int) GameSettings.Options.FRAMERATE_LIMIT.getValueMax();
	public int getMenuFrames() 
    {
    	IMenu menu = MenuRegistry.getCurrentMenu();
    	int frames = menu != null ? menu.getFrames() : -1;
    	return frames > -1 ? frames : NumberUtil.range(this.gameSettings.limitFramerate, 30, maxFrames);
	}

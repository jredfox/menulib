...
public class MusicTicker implements ITickable
{
    ...
    private static final ResourceLocation musicTicker = new ResourceLocation("minecraft:music");
    ...
    {
        this.currentMusic = PositionedSoundRecord.getMusicRecord(type.getMusicLocation());
        if(!MusicEvent.fire(musicTicker, this.currentMusic))
        {
        	return;
        }
    ...
    {
        MENU(SoundEvents.MUSIC_MENU, 0, 0/*600*/),
        GAME(SoundEvents.MUSIC_GAME, 0, 0),
        CREATIVE(SoundEvents.MUSIC_CREATIVE, 0, 0),
        CREDITS(SoundEvents.MUSIC_CREDITS, 0, 0),
        NETHER(SoundEvents.MUSIC_NETHER, 0, 0),
        END_BOSS(SoundEvents.MUSIC_DRAGON, 0, 0),
        END(SoundEvents.MUSIC_END, 0, 0);
